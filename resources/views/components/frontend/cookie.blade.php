@if(Cookie::get('cookiepolicy') == null && empty(Cookie::get('cookiepolicy')))
{{-- cookier nicht wurde gefunden --}}
       
<div id="dialog" class="fixed z-9999 inset-0 overflow-y-auto bg-gray-900 bg-opacity-75 transition-opacity">
    <div class="flex items-center justify-center min-h-screen p-4">
      {{-- 
      <div class="fixed inset-0 bg-gray-900 bg-opacity-75 transition-opacity"></div>
        --}}
      <div class="bg-white overflow-hidden rounded-md shadow-xl w-full md:w-8/12 xl:w-5/12 2xl:w-4/12 relative z-10 p-4 sm:p-6">
        <div class="bg-white">
  
          <div class="flex justify-center mb-8">
            <div class="flex justify-center items-center h-36 w-36 rounded-full bg-blue-100">
                <svg class="h-24 w-24 text-blue-100" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        ...
        <form method="POST" action="{{route('cookie.selection')}}">
            ...
            <div class="md:grid md:grid-cols-2 md:gap-4 my-4">
                <div>
                    ...
                    <p class="inline-block align-middle text-sm text-gray-500">Technisch Notwendig</p>
                </div>
                <div>
                    <input type="checkbox" name="static" class="w-5 h-5 inline-block"/>
                    <p class="inline-block align-middle text-sm text-gray-500">Statistik</p>
                </div>
            </div>
